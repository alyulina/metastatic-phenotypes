...
`pip3 install --user regex`. Check the slurm output files to see how many reads did not have a barcode match + to make sure that there was enough memory for the code to run.
